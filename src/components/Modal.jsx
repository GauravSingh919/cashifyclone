...
const Modal = ({
  ...
  return (
    <>
                      ...
                      titles.map((title, index) => (
                        <li key={index} className="relative group">
                          <div
                            ...
                            onClick={() =>
                              handleFileClick({ title, size: sizes[index] })
                            }
                          >
      ...
      <div className="fixed top-1/2 left-1/2 w-96 md:w-1/4 transform -translate-x-1/2 -translate-y-1/2 bg-white  flex items-center justify-center z-50 overflow-auto">
